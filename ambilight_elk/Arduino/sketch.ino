...
#include <Adafruit_NeoPixel.h> // trzeba zainstalować w Arduino IDE
...
#define LEDCOUNT   260       //  Number of LEDs used in your system                          
...
const char prefix[] = {0x41, 0x64, 0x61, 0x01, 0x03, 0x57};  // Prefix at the start of the transmission
...
void setup()
{
  ...
  delay (5000);                                             // 15 seconds delay at startup to avoid strange behaviours as the PI boots up etc
  // zmienilem na 5s
